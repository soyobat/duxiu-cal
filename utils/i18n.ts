...
export const translations = {
  zh: {
    ...
    settings: {
      ...
      copyButton: '复制数据',
      copySuccess: '已复制到剪贴板',
      importConfirm: '这也将覆盖您当前的所有数据。确定要恢复吗？',
  ...
  en: {
    ...
    settings: {
      ...
      importConfirm: 'This will overwrite all your current data. Are you sure?',
  ...
  ja: {
    ...
    settings: {
      ...
      dataTitle: 'データ管理',
      exportButton: 'バックアップを出力',
      importButton: 'バックアップから復元',
      copyButton: 'データをコピー',
      copySuccess: 'クリップボードにコピーしました',
      importConfirm: '現在のすべてのデータが上書きされます。本当によろしいですか？',
      importSuccess: 'データの復元に成功しました！',
      importError: '無効なバックアップファイル形式です。',
      clearData: '全データを消去',
